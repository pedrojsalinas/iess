                    ...
                    <div class="<?php
                        ...
                        <div class="common-doctor animated fadeInUp clearfix">
	                        ...
	                        if(
		                        ...
		                        inspiry_standard_thumbnail('gallery-post-single');
	                        }
	                        ?>
                        ...
                        <?php
                        $doctor_button_text = $theme_options['home_doctors_button_text'];
                        if ( !empty( $doctor_button_text ) ) {
                            ?><a class="read-more" href="<?php the_permalink(); ?>"><?php echo esc_html( $doctor_button_text ); ?></a><?php
                        }
                        ?>
                    </div>
                    <?php
