                                ...
                                <article class="content clearfix hentry">
                                    <div class="row">
                                        ...
                                        <div class="<?php bc('6','6','12',''); ?>">
                                            ...
                                            <?php
                                            $services_button_text = $theme_options['home_services_button_text'];
                                            if ( !empty( $services_button_text ) ) {
                                                ?><a rel="bookmark" class="read-more" href="<?php the_permalink(); ?>"><?php echo esc_html( $services_button_text ); ?></a><?php
                                            }
                                            ?>
                                        </div>
                                    </div>
