    ...
    <div class="container">
        <div class="row">
            ...
            <div class="<?php bc_all('12'); ?>">
                ...
                $inspiry_filter_args = apply_filters( 'inspiry_filter_news', $args );

                // The Query
                $blog_query = new WP_Query( $inspiry_filter_args );
                ...
                if ($blog_query->have_posts()) {
                    ...
                    while ($blog_query->have_posts()) {
                        ...
                        ?>">
                            ...
                            <?php
                            $news_button_text = $theme_options['home_news_button_text'];
                            if ( !empty($news_button_text) ) {
                                ?><a class="read-more" href="<?php the_permalink(); ?>"><?php echo esc_html($news_button_text); ?></a><?php
                            }
                            ?>
                        </div>
                        <?php
