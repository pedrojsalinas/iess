                                ...
                                <div class="container">
                                    <div class="home-slider-content ">
										...
										if ( ! empty( $slide['title'] ) ) : ?>
                                            <h2 class="home-slider-title animated"><?php echo $slide['title']; ?></h2><?php
										endif;

										if ( ! empty( $slide['description'] ) ) : ?>
                                            <p class="home-slider-description animated"><?php echo $slide['description']; ?></p><?php
										endif;
										?>
                                        <div class="announcement">
	                                        ...
	                                        if ( ! empty( $slide['url'] ) ) : ?>
                                                <a target=\"_blank\" class="btn btn-primary btn-block" href="<?php echo $slide['url']; ?>"><?php echo esc_html( $slider_button_text ); ?></a>
		                                        <?php
	                                        endif;
	                                        ?>
                                        </div>
