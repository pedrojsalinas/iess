        ...
        <div class="modal-dialog">
            ...
            <form id="appointment_modal_form" class="appointment-modal-form" action="<?php echo admin_url( 'admin-ajax.php' ); ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="date" id="appointment-modal-form-datepicker" class="required" autocomplete="off" placeholder="<?php esc_attr_e( 'Appointment Date', 'framework' ); ?>" title="<?php esc_attr_e( '* Please provide appointment date', 'framework' ); ?>">
                    </div>
                </div>
