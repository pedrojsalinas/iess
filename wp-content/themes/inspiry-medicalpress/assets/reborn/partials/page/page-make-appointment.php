        ...
        <div class="appoint-section clearfix">
            ...
            <form id="appointment_form_main" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="<?php bc('6','6','12',''); ?>">
                        <input type="text" name="date" id="datepicker" class="required" autocomplete="off" placeholder="<?php _e('Appointment Date', 'framework'); ?>"/  title="<?php _e('* Please provide appointment date', 'framework'); ?>">
                    </div>
                </div>
