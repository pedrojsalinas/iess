...
<header id="site-header" class="site-header">
        ...
        <div class="site-header-top">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-lg-12 site-header-top-col-right">
						<!-- <?php inspiry_social_nav('header-social-nav', 'display_top_header_social_links'); ?> -->
                        <!-- <?php get_template_part( INSPIRY_PARTIALS . '/header/header-wpml-language-switcher' ); ?> -->
    ...
    <div class="site-header-middle">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-4 col-lg-3 site-header-middle-col-left">
                ...
                <div class="col-md-4 col-lg-9 site-header-middle-col-center">
