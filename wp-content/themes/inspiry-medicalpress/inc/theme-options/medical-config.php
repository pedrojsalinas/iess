...
if (!class_exists('Medical_Theme_Redux_Framework_Config')) {
    ...
    class Medical_Theme_Redux_Framework_Config {
        ...
        public function setSections() {
	        ...
	        $this->sections[] = array(
		        ...
		        'fields' => array(
			        array(
				        ...
				        'options' => array(
					        'enabled'  => array(
						        'inline'      => __('Inline', 'framework'),
                                'quotes'      => __('Quotes', 'framework'),
            ...
            /*----------------------------------------------------------------------*/
            $this->sections[] = array(
                'title' => __('Home - Inline', 'framework'),

                'subsection' => true,
                'fields' => array(
                    array(
                        'id' => 'home_inline_title',
                        'type' => 'text',
                        'title' => __('Inline Title', 'framework'),
                        'subtitle' => __('Provide title to display above inline section on homepage.', 'framework'),
                        'desc' => 'You can wrap few words in span tag to make them bold. Example: '.htmlentities('<span>Bold Words</span> Regular Words'),
                    ),
                    array(
                        'id' => 'home_inline_description',
                        'type' => 'textarea',
                        'title' => __('Inline Description', 'framework'),
                    ...
                    array(
                        'id'        => 'inline_variation',
                        'type'      => 'image_select',
                        'title'     => __('Inline Section Design', 'framework'),
                        'subtitle'  => __('Select the design variation that you want to use for inline on homepage.', 'framework'),
                        //Must provide key => value(array:title|img) pairs for radio options
                        'options'   => array(
                            '1' => array('title' => __('1st Variation', 'framework'), 'img' => INSPIRY_COMMON_DIR_URI . '/images/theme-options/inline_variation_1.jpg'),
                            '2' => array('title' => __('2nd Variation', 'framework'), 'img' => INSPIRY_COMMON_DIR_URI . '/images/theme-options/inline_variation_2.jpg'),
                            '3' => array('title' => __('3rd Variation', 'framework'), 'img' => INSPIRY_COMMON_DIR_URI . '/images/theme-options/inline_variation_3.jpg')
                        ),
                        'default'   => '1',
                        'required'  => array('inspiry_design_variation', '=', 'default')
                    ),
                    array(
                        ...
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_button_url',
                        'type' => 'text',
                        'validate'  => 'url',
                    ...
                    array(
                        'id' => 'inline_var_1_icon_1',
                        'type' => 'text',
                        'title' => __('1st Inline Icon Code', 'framework'),
                        'subtitle' => __('Provide the Font Awesome icon code', 'framework'),
                        'desc' => 'Example value: '.htmlentities('<i class="fa fa-plus-square"></i>'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_title_1',
                        'type' => 'text',
                        'title' => __('1st Inline Title', 'framework'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_url_1',
                        'type' => 'text',
                        'validate'  => 'url',
                        'title' => __('1st Inline URL', 'framework'),
                        'subtitle' => __('If you want to display inline title as link then provide the target URL.', 'framework'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_desc_1',
                        'type' => 'textarea',
                        'title' => __('1st Inline Description', 'framework'),
                        'subtitle' => __('Provide inline description text.', 'framework'),
                        'validate' => 'no_html',
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    ...
                    array(
                        'id' => 'inline_var_1_icon_2',
                        'type' => 'text',
                        'title' => __('2nd Inline Icon Code', 'framework'),
                        'subtitle' => __('Provide the Font Awesome icon code', 'framework'),
                        'desc' => 'Example value: '.htmlentities('<i class="fa fa-wheelchair"></i>'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_title_2',
                        'type' => 'text',
                        'title' => __('2nd Inline Title', 'framework'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_url_2',
                        'type' => 'text',
                        'validate'  => 'url',
                        'title' => __('2nd Inline URL', 'framework'),
                        'subtitle' => __('If you want to display inline title as link then provide the target URL.', 'framework'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_desc_2',
                        'type' => 'textarea',
                        'title' => __('2nd Inline Description', 'framework'),
                        'subtitle' => __('Provide inline description text.', 'framework'),
                        'validate' => 'no_html',
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    ...
                    array(
                        'id' => 'inline_var_1_icon_3',
                        'type' => 'text',
                        'title' => __('3rd Inline Icon Code', 'framework'),
                        'subtitle' => __('Provide the Font Awesome icon code', 'framework'),
                        'desc' => 'Example value: '.htmlentities('<i class="fa fa-user-md"></i>'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_title_3',
                        'type' => 'text',
                        'title' => __('3rd Inline Title', 'framework'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_url_3',
                        'type' => 'text',
                        'validate'  => 'url',
                        'title' => __('3rd Inline URL', 'framework'),
                        'subtitle' => __('If you want to display inline title as link then provide the target URL.', 'framework'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_desc_3',
                        'type' => 'textarea',
                        'title' => __('3rd Inline Description', 'framework'),
                        'subtitle' => __('Provide inline description text.', 'framework'),
                        'validate' => 'no_html',
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    ...
                    /* 1st Variation - Options set 1*/
                    array(
                        'id' => 'inline_var_1_icon_4',
                        'type' => 'text',
                        'title' => __('4th Inline Icon Code', 'framework'),
                        'subtitle' => __('Provide the Font Awesome icon code', 'framework'),
                        'desc' => 'Example value: '.htmlentities('<i class="fa fa-ambulance"></i>'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_title_4',
                        'type' => 'text',
                        'title' => __('4th Inline Title', 'framework'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_url_4',
                        'type' => 'text',
                        'validate'  => 'url',
                        'title' => __('4th Inline URL', 'framework'),
                        'subtitle' => __('If you want to display inline title as link then provide the target URL.', 'framework'),
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    array(
                        'id' => 'inline_var_1_desc_4',
                        'type' => 'textarea',
                        'title' => __('4th Inline Description', 'framework'),
                        'subtitle' => __('Provide inline description text.', 'framework'),
                        'validate' => 'no_html',
                        'required'  => array( 'inline_variation', '=', '1' )
                    ),
                    ...
                    /* 2nd Variation */
                    array(
                        'id' => 'variation_2_inline',
                        'type' => 'slides',
                        'title' => __('2nd Variation Inline', 'framework'),
                        'subtitle' => __('Inline images should have similar width and height.', 'framework'),
                        'show' => array(
                            'title'         => true,
                            'description'   => true,
                            'url'           => true
                        ...
                        'placeholder' => array(
                            'title' => __('Inline Title', 'framework'),
                            'description' => __('Inline Description', 'framework'),
                            'url' => __('Inline link if any', 'framework')
                        ),
                        'required'  => array( 'inline_variation', '=', '2' )
                    ),

                    /* 3rd Variation */
                    array(
                        'id' => 'variation_3_inline',
                        'type' => 'slides',
                        'title' => __('3rd Variation Inline', 'framework'),
                        'subtitle' => __('Inline images should have 70px width and 70px height.', 'framework'),
                        'show' => array(
                            'title'         => true,
                            'description'   => true,
                            'url'           => true
                        ...
                        'required'  => array( 'inline_variation', '=', '3' )
                    ),

                    /* Variation Two inline */
                    array(
                        'id' => 'inline_variation_2',
                        'type' => 'slides',
                        'title' => __('Inline', 'framework'),
                        'subtitle' => __('Inline images should have similar width and height.', 'framework'),
                        'show' => array(
                            'title'         => true,
                            'description'   => true,
               	...
               	array(
                        'id' => 'home_inline_button_text',
                        'type' => 'text',
                        'title' => __('Inline Button Text', 'framework'),
						'desc' => 'Button text for each service e.g. "Learn More". Leave it blank will remove the button entirely.',
						'default' => __('Read More', 'framework'),
						'required'  => array('inspiry_design_variation', '=', 'default')
                    ),
	                
                    array(
	                    'id' => 'display_show_all_inline_button',
	                    'type' => 'switch',
	                    'title' => __('Display "View All Inline" Button', 'framework'),
	                    'default' => '0',
	                    'on' => __('Display','framework'),
	                    'off' => __('Hide','framework'),
	                    'required'  => array('inspiry_design_variation', '=', 'reborn')
	                ...
	                array(
		                'id' => 'show_all_inline_button_link',
		                'type' => 'text',
		                'title' => __('Button Link', 'framework'),
		                'default'   => '#',
		                'required' => array( array( 'display_show_all_inline_button', '=', '1' ), array('inspiry_design_variation', '=', 'reborn') )
	                ),
               )
            );
...
/*----------------------------------------------------------------------*/
            ...
            /*----------------------------------------------------------------------*/
            $this->sections[] = array(
                'title' => __('Home - Quotes', 'framework'),
                'subsection' => true,
                'fields' => array(
                    array(
                        'id' => 'home_quotes_title',
                        'type' => 'text',
                        'title' => __('Quotes Title', 'framework'),
                        'subtitle' => __('Provide title to display above quotes section on homepage.', 'framework'),
                        'desc' => 'You can wrap few words in span tag to make them bold. Example: '.htmlentities('<span>Bold Words</span> Regular Words'),
                    ),
                    array(
                        'id' => 'home_quotes_description',
                        'type' => 'textarea',
                        'title' => __('Quotes Description', 'framework'),
                        'subtitle' => __('Provide the text description to display below title in services section on homepage.', 'framework'),
                        'validate' => 'no_html',
                    ),
                    array(
                        ...
                        'subtitle' => __('Do you want to display call to action section above quotes ?', 'framework'),
                        'default' => '1',
                        'on' => __('Display','framework'),
                        'off' => __('Hide','framework'),
                        'required' => array('inspiry_design_variation', '=', 'reborn')
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
					...
					array(
                        'id' => 'home_doctors_button_text',
                        'type' => 'text',
                        'title' => __('Doctor\'s Button Text', 'framework'),
						'desc' => 'Button text for each doctor e.g. "Read More". Leave it blank will remove the "Read More" button from Doctor\'s section ',
						'default' => __('Read More', 'framework'),
						'required'  => array('inspiry_design_variation', '=', 'default')
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
					...
					array(
                        'id' => 'home_services_button_text',
                        'type' => 'text',
                        'title' => __('Services Button Text', 'framework'),
						'desc' => 'Button text for each service e.g. "Learn More". Leave it blank will remove the button entirely.',
						'default' => __('Read More', 'framework'),
						'required'  => array('inspiry_design_variation', '=', 'default')
                    ),
					...
					array(
		                'id'       => 'home_number_of_exerpt_services',
		                'type'     => 'select',
		                'title'    => __('Number of Words for Excerpts ', 'framework'),
		                'default'  => '12',
		                'options'  => array(
							'9' => '9',
							'10' => '10',
            ...
            $this->sections[] = array(
				...
				'desc' => __('All news\' posts <strong>must have a Featured Image assigned</strong> otherwise they will not be shown on homepage.', 'framework'),
                'subsection' => true,
                'fields' => array(
                    array(
                        'id' => 'home_news_title',
					...
					array(
						'id'       => 'home_news_type',
						'type'     => 'button_set',
						'title'    => __( 'Type of News Posts', 'framework' ),
						'desc' => __( 'Choose the type of news posts to display on homepage.', 'framework' ),
						'options'  => array(
							'recent' => __('Recent', 'framework'),
							'category' => __('Based on Categories', 'framework'),
							'tag' => __('Based on Tags', 'framework'),
							'author' => __('Based on Authors', 'framework'),
						),
						'default'  => 'recent',
					),
					array(
						...
						'multi'    => true,
						'data'     => 'categories',
						'title'    => __( 'Select Categories', 'framework' ),
						'required' => array( 'home_news_type', '=', 'category' ),
					),
					array(
						'id'       => 'home_news_tag',
						'type'     => 'select',
						'multi'    => true,
						'data'     => 'tags',
						'title'    => __( 'Select Tags', 'framework' ),
						'required' => array( 'home_news_type', '=', 'tag' ),
					),
					array(
						'id'       => 'home_news_author',
						'type'     => 'select',
						'multi'    => true,
						'data'     => 'users',
						'title'    => __( 'Select Author', 'framework' ),
						'required' => array( 'home_news_type', '=', 'author' ),
					),
					array(
                        'id' => 'home_news_button_text',
                        'type' => 'text',
                        'title' => __('News Button Text', 'framework'),
						'desc' => 'Button text for each news post e.g. "Continue Reading". Leave it blank will remove the button completely.',
						'default' => __('Read More', 'framework'),
						'required'  => array('inspiry_design_variation', '=', 'default')
                    ),
                    array(
                    ...
                    array(
                        'id' => 'display_show_all_noticias_button',
                        'type' => 'switch',
                        'title' => __('Display "View All Noticias" Button', 'framework'),
                        'default' => '0',
                        'on' => __('Display','framework'),
                        'off' => __('Hide','framework'),
                        'required'  => array('inspiry_design_variation', '=', 'reborn')
                    ...
                    array(
                        'id' => 'show_all_noticias_button_link',
                        'type' => 'text',
                        'title' => __('Button Link', 'framework'),
                        'default'   => '#',
                        'required' => array( array( 'display_show_all_noticias_button', '=', '1' ), array('inspiry_design_variation', '=', 'reborn') )
                    ),
                    array(
                        'id' => 'show_content',
                        'type' => 'text',
                        'title' => __('Name Link', 'framework'),
                        'default'   => '#',
                        'required' => array( array( 'display_show_all_noticias_button', '=', '1' ), array('inspiry_design_variation', '=', 'reborn') )
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
	                ...
	                array(
		                'id' => 'display_doctors_hover_effect',
		                'type' => 'switch',
		                'title' => __('Doctors Thumbnail Hover Effect', 'framework'),
		                'subtitle' => __('Do you want to display the hover effect on doctors listing templates?', 'framework'),
		                'default' => '1',
		                'on' => __('Display','framework'),
		                'off' => __('Hide','framework')
	                )
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
	                ...
	                array(
		                ...
		                'type' => 'switch',
		                'title' => __('Display "View All Doctors" Button', 'framework'),
		                'default' => '0',
		                'on' => __('Display','framework'),
		                'off' => __('Hide','framework'),
		                'required'  => array('inspiry_design_variation', '=', 'reborn')
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
					array(
		                'id'       => 'page_number_of_exerpt_services',
		                'type'     => 'select',
		                'title'    => __('Number of Words for Excerpts ', 'framework'),
		                'default'  => '13',
		                'options'  => array(
	                ...
	                array(
		                'id' => 'display_services_hover_effect',
		                'type' => 'switch',
		                'title' => __('Services Thumbnail Hover Effect', 'framework'),
		                'subtitle' => __('Do you want to display the hover effect on services listing templates?', 'framework'),
		                'default' => '1',
		                'on' => __('Display','framework'),
		                'off' => __('Hide','framework')
	                )
	        ...
	        $this->sections[] = array(
		        ...
		        'desc'   => __( 'This section contains GDPR related settings.', 'framework' ),
		        'fields' => array(
			        array(
				        'id'      => 'gdpr_label_text',
				        'type'    => 'text',
				        'title'   => __( 'GDPR Agreement Checkbox Label', 'framework' ),
				        'default' => __( 'GDPR Agreement', 'framework' ),
			        ),
			        array(
				        'id'      => 'gdpr_text',
				        'type'    => 'textarea',
				        'title'   => __( 'GDPR Agreement Checkbox Text', 'framework' ),
				        'default' => __( 'I consent to having this website store my submitted information so they can respond to my inquiry.', 'framework' ),
				        'desc'    => __( 'You can use strong, em and a tags in agreement text.', 'framework' ),
			        ),
			        array(
				        'id'      => 'gdpr_validation_message',
				        'type'    => 'text',
				        'title'   => __( 'GDPR Agreement Validation Message', 'framework' ),
				        'default' => __( '* Please accept GDPR Agreement', 'framework' ),
			        ),
			        array(
				        'id'      => 'gdpr_contact_form',
				        'type'    => 'switch',
				        'title'   => __( 'GDPR checkbox for Contact Form', 'framework' ),
				        'default' => '0',
				        'on'      => __( 'Enable', 'framework' ),
				        'off'     => __( 'Disable', 'framework' ),
			        ),
			        array(
				        'id'      => 'gdpr_appointment_form',
				        'type'    => 'switch',
				        'title'   => __( 'GDPR checkbox for Appointment Form', 'framework' ),
				        'default' => '0',
				        'on'      => __( 'Enable', 'framework' ),
				        'off'     => __( 'Disable', 'framework' ),
			        ),
	        ...
	        $this->sections[] = array(
		        ...
		        'desc'   => __('This section contains the slugs for each custom post type options. After saving the settings, don\'t forget save the <u>Permalinks Settings</u> again in <strong>Dashboard &rarr; Settings &rarr; Permalinks</strong> to refresh slugs of WordPress.', 'framework'),
		        'fields' => array(
			        array(
				        'id'      => 'doctor_slugs',
				        'type'    => 'text',
				        'style'   => 'info',
						'title'   => __('Doctor\'s Slug', 'framework'),
						'default' => __('doctor', 'framework'),
				        'desc'    => 'Slug for Doctor Post Type ( http://yourwebsite.com/<strong>doctor</strong>/john-doe/ ).',
					),
					array(
				        'id'      => 'gallery_slugs',
				        'type'    => 'text',
				        'style'   => 'info',
						'title'   => __('Gallery\'s Slug', 'framework'),
						'default' => __('gallery-item', 'framework'),
				        'desc'    => 'Slug for Gallery Post Type ( http://yourwebsite.com/<strong>gallery-item</strong>/medical-record-keeping/ ).',
					),
					array(
				        'id'      => 'service_slugs',
				        'type'    => 'text',
				        'style'   => 'info',
						'title'   => __('Service\'s Slug', 'framework'),
						'default' => __('service', 'framework'),
				        'desc'    => 'Slug for Service Post Type ( http://yourwebsite.com/<strong>service</strong>/medical-research/ ).',
			        ),
				)
			);
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'        => 'quotes_overlay_bg_color',
                        'type'      => 'color',
                        'transparent' => false,
                        'output'    => array(
                            'background-color' => '.quotes-image-overlay',
                        ),
                        'title'     => __('Quotes Overlay Background Color', 'framework'),
                        'desc'  => 'default: #007d9e',
                        'default'   => '#007d9e',
                        'validate'  => 'color',
                        'required' => array( array( 'want_to_change_theme_styling', '=', '1' ), array('inspiry_design_variation', '=', 'reborn') )
                    ...
                    array(
                        'id'        => 'quotes_title_color',
                        'type'      => 'color',
                        'transparent' => false,
                        'output'    => array('.page-title'),
                        'title'     => __('Quotes Title Color', 'framework'),
                        'desc'  => 'default: #ffffff',
                        'default'   => '#ffffff',
                        'validate'  => 'color',
                        'required' => array( array( 'want_to_change_theme_styling', '=', '1' ), array('inspiry_design_variation', '=', 'reborn') )
