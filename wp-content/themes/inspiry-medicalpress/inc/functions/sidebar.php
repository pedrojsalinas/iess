...
if ( function_exists( 'register_sidebar' ) ) {
	...
	register_sidebar( array(
		'id'            => 'footer-5th-column',
		'name'          => __( 'Footer Five Column', 'framework' ),
		'description'   => __( 'This represents the 5st column widget area in footer.', 'framework' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="title">',
		'after_title'   => '</h3>'
	...
	register_sidebar( array(
		'id'            => 'footer-letter',
		'name'          => __( 'Footer Letter', 'framework' ),
		'description'   => __( 'This represents the footer letter widget area in footer.', 'framework' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="title">',
		'after_title'   => '</h3>'
