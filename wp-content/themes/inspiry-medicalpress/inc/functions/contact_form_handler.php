...
if ( ! function_exists( 'send_message' ) ) {
	...
	function send_message() {
		...
		if ( isset( $_POST['email'] ) ) {
			...
			$gdpr_agreement = $_POST['contact-form-gdpr-checkbox'];
...
//				$email_body .= __( "GDPR Agreement:", 'framework' ) . " <br/>";
//				$email_body .= wp_kses( $gdpr_agreement, $allowed_html_tags ) . " <br/>";
//			}
...
if ( ! function_exists( 'make_appointment' ) ) {
	...
	function make_appointment() {
		...
		if ( isset( $_POST['email'] ) ):
			...
			$message          = stripslashes( $_POST['message'] );
			$gdpr_agreement   = $_POST['appointment-form-gdpr-checkbox'];
			$from_email       = sanitize_email( $_POST['email'] );
			$from_email       = is_email( $from_email );
			if ( ! $from_email ) {
				echo json_encode( array(
