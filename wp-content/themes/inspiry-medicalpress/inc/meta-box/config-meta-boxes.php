	    ...
	    if ( 'reborn' == INSPIRY_DESIGN_VARIATION ) {
         // Meta Box for single service icon
		    $meta_boxes[] = array(
			    'title' => __('Icon Settings', 'framework'),
			    'pages' => array('inline'),
			    'id' => 'inline-icon-meta-box',
			    'context' => 'normal',
			    'priority' => 'high',
			    'fields' => array(
				    array(
					    'name' => __('Inline Icon', 'framework'),
					    'id' => "{$prefix}inline_icon",
					    'desc' => __('The inline icon should have minimum width and height of 64px (Bigger size icon will be adjusted proportionally).', 'framework'),
					    'type' => 'image_advanced',
					    'max_file_uploads' => 1
				    )
			    )
